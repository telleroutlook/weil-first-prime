...
and prove the Path~B Schur criterion (\cref{thm:schur}) with the certified
Weil constant $c_L(7/20) = \log(2\pi\cdot\tfrac{7}{20}) + \gamma_E \approx 1.36527$
(derived from Suzuki~\cite{Suzuki2026} equation~(4.5); see \cref{rem:conventions}(ii)).
